...
namespace FasilitasKamar
{
    public partial class UpdateFasilitas : Form
    {
        ...
        {
            using (NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5432;Database=pbo;User Id=postgres;Password=123456789;"))
            {
                //conn.Open();
        ...
        {
            Fasilitas_Kamar fasilitasKamar = new Fasilitas_Kamar();
            fasilitasKamar.Show();
            this.Hide();
        }
